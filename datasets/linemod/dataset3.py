...
class PoseDataset(data.Dataset):
    def __init__(self, mode, num_pointcloud, add_noise, root, noise_trans, refine, objlist=None):
        ...
        """
        self.objlist = [14, 25, 26, 27, 28, 29, 30, 31, 32, 33] if objlist is None else objlist
        self.mode = mode
    ...
    def __getitem__(self, index):
        ...
        # Check if the image is greyscale and convert if necessary
        if img.mode == 'L':
            img = img.convert('RGB')
